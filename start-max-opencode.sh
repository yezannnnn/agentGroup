#!/bin/bash
# 启动 Max-OpenCode 模式 - 使用 OpenCode AI 引擎，启用代码智能
# 用法: ./start-max-opencode.sh

cd "$(dirname "$0")"

echo "=========================================="
echo "  启动 Max-OpenCode 模式"
echo "  AI引擎: OpenCode (Code Intelligence)"
echo "  人设来源: max/CLAUDE.md"
echo "  Code Intelligence: 已启用 (代码生成优化)"
echo "  角色: 项目经理 / 产品顾问"
echo "=========================================="
echo ""
...
if command -v opencode >/dev/null 2>&1; then
    ...
    echo "请安装 OpenCode: npm install -g @opencodeai/cli"
    exit 1
fi
...
echo ""
echo "💡 提示: OpenCode 将使用 Max(Claude) 的人设和技能"
echo "💡 Code Intelligence: 代码生成、重构、优化智能增强"
echo "💡 与 ./start-max.sh 的区别: AI引擎不同，专注代码智能"
echo ""
