#!/bin/bash
# 启动 Jarvis-OpenCode 模式 - 使用 OpenCode AI 引擎，启用代码智能
# 用法: ./start-jarvis-opencode.sh

cd "$(dirname "$0")"

echo "=========================================="
echo "  启动 Jarvis-OpenCode 模式"
echo "  AI引擎: OpenCode (Code Intelligence)"
echo "  人设来源: jarvis/CLAUDE.md"
echo "  Code Intelligence: 已启用 (全栈开发优化)"
echo "  角色: 开发工程师 / 全栈专家"
echo "=========================================="
echo ""
...
echo ""
echo "💡 提示: OpenCode 将使用 Jarvis(Claude) 的人设和技能"
echo "💡 Code Intelligence: 全栈开发、架构设计、代码重构智能"
echo "💡 与 ./start-jarvis.sh 的区别: AI引擎不同，专注开发代码智能"
echo ""
...
case "$choice" in
    ...
    3)
        echo "📋 正在列出所有可用会话..."
        echo ""
        cd "./jarvis" && opencode session list
        echo ""
