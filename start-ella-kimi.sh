#!/bin/bash
# 启动 Ella-Kimi 模式 - 使用 Kimi AI 引擎，但加载 Ella(Claude) 的人设
# 角色: UI/UX设计师
# 用法: ./start-ella-kimi.sh

cd "$(dirname "$0")"

echo "=========================================="
echo "  启动 Ella-Kimi 模式"
...
# 进入 ella 目录（Kimi 将在这里工作，读取 CLAUDE.md 等人设）
cd "./ella"
...
echo ""
echo "💡 提示: Kimi 将使用 Ella(Claude) 的设计人设和技能"
echo "💡 与 ./start-ella.sh 的区别: AI引擎不同，人设相同"
echo ""
